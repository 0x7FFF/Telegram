...
import org.telegram.ui.EllipsisDrawable;
import org.telegram.ui.RoundedBackgroundDrawable;
...
public class VoIPStatusTextView extends FrameLayout {
    ...
    public VoIPStatusTextView(@NonNull Context context) {
        ...
        reconnectTextView.setPadding(padding, 0, padding, 0);
        reconnectTextView.setBackground(
    ...
    public void setText(String nextString, boolean ellipsis, boolean animated) {
        ...
        if (!animated) {
            ...
            textView[0].setCompoundDrawablesWithIntrinsicBounds(null, null, ellipsis ? new EllipsisDrawable() : null, null);
            ...
            if (timerShowing) {
                ...
                if (!textView[0].getText().equals(nextString)) {
                    ...
                    textView[1].setCompoundDrawablesWithIntrinsicBounds(null, null, ellipsis ? new EllipsisDrawable() : null, null);
                    replaceViews(
                        textView[0],
                        textView[1],
                        () -> {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (nextTextToSet != null) {
                    if (nextTextToSet.equals("timer")) {
                        ...
                        textView[1].setCompoundDrawablesWithIntrinsicBounds(null, null, nextTextHasEllipsis ? new EllipsisDrawable() : null, null);
