...
public class OpenGLBitmapProcessor {
    ...
    private int createProgram() {
        int vert = ShaderUtils.createShader(context, GL_VERTEX_SHADER, R.raw.share_blur_vert);
        int frag = ShaderUtils.createShader(context, GL_FRAGMENT_SHADER, R.raw.share_blur_frag);
        return ShaderUtils.createProgram(vert, frag);
    }

    private int createMorphProgram() {
        int vert = ShaderUtils.createShader(context, GL_VERTEX_SHADER, R.raw.share_morph_vert);
        int frag = ShaderUtils.createShader(context, GL_FRAGMENT_SHADER, R.raw.share_morph_frag);
        return ShaderUtils.createProgram(vert, frag);
    }
