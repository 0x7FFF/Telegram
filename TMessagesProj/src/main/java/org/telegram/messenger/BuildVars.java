...
public class BuildVars {
    ...
    public static int APP_ID = 12145335;
    public static String APP_HASH = "4058677629542942efec12ec0a92a97d";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "org.valdoxgram.messenger.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
